...
import {
  ...
  settingsProxySchema,
  settingsScheduleGenerateResponseSchema,
...
export const contractRoutesSettingsTheme = {
  ...
  settingsScheduleGenerate: {
    method: 'POST',
    path: '/api/v1/settings/schedule/generate',
    headers: authHeaderSchema,
    body: settingsScheduleGenerateSchema,
    responses: {
      200: successEnvelopeSchema(settingsScheduleGenerateResponseSchema),
      400: errorEnvelopeSchema,
      401: errorEnvelopeSchema,
      403: errorEnvelopeSchema,
      422: errorEnvelopeSchema,
    },
    summary: 'Generate schedule with optional deterministic seed',
  },
  themeAssetsComplete: {
    method: 'POST',
