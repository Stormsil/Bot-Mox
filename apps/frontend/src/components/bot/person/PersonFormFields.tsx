  ...
  <>
    <Row gutter={16}>
      <Col xs={24} sm={12} md={8}>
        <Form.Item
          label={<FieldLabel form={form} field="first_name" label="First Name" />}
          name="first_name"
        >
      ...
      <Col xs={24} sm={12} md={8}>
        <Form.Item
          label={<FieldLabel form={form} field="last_name" label="Last Name" />}
          name="last_name"
        >
      ...
      <Col xs={24} sm={12} md={8}>
        <Form.Item
          label={<FieldLabel form={form} field="birth_date" label="Birth Date" />}
          name="birth_date"
        >
    ...
    <Row gutter={16}>
      <Col xs={24} sm={12} md={8}>
        <Form.Item
          label={<FieldLabel form={form} field="country" label="Country" />}
          name="country"
        >
          <Select
    ...
    <Row gutter={16}>
      <Col xs={24} md={16}>
        <Form.Item
          label={<FieldLabel form={form} field="address" label="Address" />}
          name="address"
        >
          <Input
            placeholder="Enter full address (street, house number)"
            autoComplete="off"
            disabled={manualEditLocked}
          />
        </Form.Item>
