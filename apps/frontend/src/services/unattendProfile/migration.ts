...
import {
  ...
  type UnattendCapabilityRemovalConfig,
  type UnattendComputerNameConfig,
  type UnattendCustomScript,
  type UnattendDesktopIcons,
  type UnattendLocaleConfig,
  type UnattendProfileConfig,
  type UnattendSoftwareRemovalConfig,
  type UnattendUserConfig,
  type UnattendVisualEffects,
