...
export const KEYBOARD_GROUPS: KeyboardLanguageGroup[] = [
  {
    tag: 'af-ZA', name: 'Afrikaans', languageId: '0436',
    layouts: [
  ...
  {
    tag: 'ar-SA', name: 'Arabic (Saudi Arabia)', languageId: '0401',
    layouts: [
  ...
  {
    tag: 'bg-BG', name: 'Bulgarian', languageId: '0402',
    layouts: [
  ...
  {
    tag: 'cs-CZ', name: 'Czech', languageId: '0405',
    layouts: [
  ...
  {
    tag: 'da-DK', name: 'Danish', languageId: '0406',
    layouts: [
      { id: '00000406', name: 'Danish', languageId: '0406' },
    ],
  },
  {
    tag: 'de-DE', name: 'German', languageId: '0407',
    layouts: [
  ...
  {
    tag: 'de-AT', name: 'German (Austria)', languageId: '0C07',
    layouts: [
      { id: '00000407', name: 'German', languageId: '0C07' },
    ],
  },
  {
    tag: 'de-CH', name: 'German (Switzerland)', languageId: '0807',
    layouts: [
  ...
  {
    tag: 'el-GR', name: 'Greek', languageId: '0408',
    layouts: [
  ...
  {
    tag: 'en-US', name: 'English (US)', languageId: '0409',
    layouts: [
  ...
  {
    tag: 'en-GB', name: 'English (UK)', languageId: '0809',
    layouts: [
  ...
  {
    tag: 'es-ES', name: 'Spanish (Spain)', languageId: '0C0A',
    layouts: [
  ...
  {
    tag: 'es-MX', name: 'Spanish (Mexico)', languageId: '080A',
    layouts: [
      { id: '0000080A', name: 'Latin American', languageId: '080A' },
    ],
  },
  {
    tag: 'et-EE', name: 'Estonian', languageId: '0425',
    layouts: [
      { id: '00000425', name: 'Estonian', languageId: '0425' },
    ],
  },
  {
    tag: 'fi-FI', name: 'Finnish', languageId: '040B',
    layouts: [
  ...
  {
    tag: 'fr-FR', name: 'French (France)', languageId: '040C',
    layouts: [
  ...
  {
    tag: 'fr-CA', name: 'French (Canada)', languageId: '0C0C',
    layouts: [
  ...
  {
    tag: 'he-IL', name: 'Hebrew', languageId: '040D',
    layouts: [
  ...
  {
    tag: 'hi-IN', name: 'Hindi', languageId: '0439',
    layouts: [
  ...
  {
    tag: 'hr-HR', name: 'Croatian', languageId: '041A',
    layouts: [
      { id: '0000041A', name: 'Croatian', languageId: '041A' },
    ],
  },
  {
    tag: 'hu-HU', name: 'Hungarian', languageId: '040E',
    layouts: [
  ...
  {
    tag: 'id-ID', name: 'Indonesian', languageId: '0421',
    layouts: [
      { id: '00000409', name: 'US', languageId: '0421' },
    ],
  },
  {
    tag: 'it-IT', name: 'Italian', languageId: '0410',
    layouts: [
  ...
  {
    tag: 'ja-JP', name: 'Japanese', languageId: '0411',
    layouts: [
  ...
  {
    tag: 'ko-KR', name: 'Korean', languageId: '0412',
    layouts: [
  ...
  {
    tag: 'lt-LT', name: 'Lithuanian', languageId: '0427',
    layouts: [
  ...
  {
    tag: 'lv-LV', name: 'Latvian', languageId: '0426',
    layouts: [
  ...
  {
    tag: 'nb-NO', name: 'Norwegian (Bokm\u00E5l)', languageId: '0414',
    layouts: [
  ...
  {
    tag: 'nl-NL', name: 'Dutch', languageId: '0413',
    layouts: [
  ...
  {
    tag: 'pl-PL', name: 'Polish', languageId: '0415',
    layouts: [
  ...
  {
    tag: 'pt-BR', name: 'Portuguese (Brazil)', languageId: '0416',
    layouts: [
  ...
  {
    tag: 'pt-PT', name: 'Portuguese (Portugal)', languageId: '0816',
    layouts: [
      { id: '00000816', name: 'Portuguese', languageId: '0816' },
    ],
  },
  {
    tag: 'ro-RO', name: 'Romanian', languageId: '0418',
    layouts: [
  ...
  {
    tag: 'ru-RU', name: 'Russian', languageId: '0419',
    layouts: [
  ...
  {
    tag: 'sk-SK', name: 'Slovak', languageId: '041B',
    layouts: [
  ...
  {
    tag: 'sl-SI', name: 'Slovenian', languageId: '0424',
    layouts: [
      { id: '00000424', name: 'Slovenian', languageId: '0424' },
    ],
  },
  {
    tag: 'sr-Latn-RS', name: 'Serbian (Latin)', languageId: '081A',
    layouts: [
      { id: '0000081A', name: 'Serbian (Latin)', languageId: '081A' },
    ],
  },
  {
    tag: 'sv-SE', name: 'Swedish', languageId: '041D',
    layouts: [
  ...
  {
    tag: 'th-TH', name: 'Thai', languageId: '041E',
    layouts: [
  ...
  {
    tag: 'tr-TR', name: 'Turkish', languageId: '041F',
    layouts: [
  ...
  {
    tag: 'uk-UA', name: 'Ukrainian', languageId: '0422',
    layouts: [
  ...
  {
    tag: 'vi-VN', name: 'Vietnamese', languageId: '042A',
    layouts: [
      { id: '0000042A', name: 'Vietnamese', languageId: '042A' },
    ],
  },
  {
    tag: 'zh-CN', name: 'Chinese (Simplified)', languageId: '0804',
    layouts: [
  ...
  {
    tag: 'zh-TW', name: 'Chinese (Traditional)', languageId: '0404',
    layouts: [
